...
#define SPLIT3 true
#define Mask_BC 314138123
#define CMD_SUCCESS "OK"
#define COUNTTIME true
#define EMPTYRUN true
...
#define LOG_MINI_BATCH 7//4
#define MINI_BATCH_SIZE (1 << LOG_MINI_BATCH)
#define LOG_LEARNING_RATE 0 //5
...
typedef std::pair<longType, longType> RSSLongType;
