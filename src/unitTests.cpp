...
void runTest(string str, string whichTest, string &network)
{
	if (str.compare("Debug") == 0)
	{
		...
		else if (whichTest.compare("VecMul") == 0)
		{
			network = "Debug VecMul";
			debugVecMul();
		}
		else if (whichTest.compare("Softmax") == 0)
		{
			network = "Debug Softmax";
			debugSoftmax();
		}
		else if (whichTest.compare("Avg") == 0)
		{
			network = "Debug Avg";
			debugAvgpool();
		}
		else if (whichTest.compare("LN") == 0)
		{
			network = "Debug LN";
			debugLN();
		}
		else if (whichTest.compare("MMM") == 0)
		{
			network = "Debug MMM";
			debugMatMulMix();
		}
